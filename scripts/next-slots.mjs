// Gibt die nächsten Slots Montag + Mittwoch, 08:00 Europe/Vienna, als UTC-ISO
// (Buffer `dueAt`) aus. Nur eingebautes Intl — keine Dependencies, kein Shell-tz.
// Ausgabe: {"mon":"...Z","wed":"...Z","monLocal":"...","wedLocal":"..."}
...
console.log(JSON.stringify({ mon: iso(monMs), wed: iso(wedMs), monLocal: local(monMs), wedLocal: local(wedMs) }));
